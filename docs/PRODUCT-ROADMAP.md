...
- 支持导入、启停和卸载最大 32 KB 的 `workmode-skin/v1/v2` 本地声明式皮肤；v2 增加安全材质、组件几何和装饰预设，首个 `soft-cream + notebook` 组合可控制厚度、内高光、颗粒、按钮深度和分组件圆角；不执行 CSS、JavaScript、HTML、URL、图片或权限声明；
