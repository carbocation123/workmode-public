...
- `literature-paper`、`literature-detail`、`literature-import`、`literature-memory`、`literature-notes`；
...
截至 2026-07-14，维护机八套奖励皮肤都已完成当前功能大厅、科研工作台和文献智库的独立槽位布局与视觉 CSS，覆盖入口卡、文献卡、上下文、左右消息、工具、输入区、记忆/笔记弹窗和 PDF 容器；八个新签名包均已通过生产公钥验签。彩墨实验场与酒保行动已经进入人工视觉回归，绿磷终端 4.2.0、奶油泡芙 3.4.0、紫晶星象塔 3.3.0、霜核机能台 3.3.0、午夜控制台 3.3.0 和 Neon Ice 3.3.0 仍须重新导入、重启并逐页截图验收。导入状态、源码迁移状态和人工视觉状态必须分别记录。
